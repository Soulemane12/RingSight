        ...
        try {
          const res = await fetch('/api/flag', {
            ...
            body: JSON.stringify({
              ...
              transaction_count: selectedCase.transaction_count,
              accounts: selectedCase.accounts,
              relationship_ids: selectedCase.relationship_ids,
              transaction_ids: selectedCase.transaction_ids,
              connector_accounts: selectedCase.connector_accounts,
              chains: selectedCase.chains,
              ranking_reasons: selectedCase.ranking_reasons,
              recommended_action: selectedAction?.recommended_action,
              urgency: selectedAction?.urgency,
              plain_english_action: selectedAction?.plain_english_action,
              analyst_instructions: selectedAction?.analyst_instructions,
              action_reasons: selectedAction?.reasons.map(reason => ({
                reason_code: reason.reason_code,
                explanation: reason.explanation,
                supporting_finding_ids: reason.supporting_finding_ids,
                supporting_relationship_ids: reason.supporting_relationship_ids,
                supporting_transaction_ids: reason.supporting_transaction_ids,
              })),
